...
<body>
        ...
        <div class="row site-hero-inner justify-content-center align-items-center">
          ...
          <form style="" action="#" method="post" class="bg-white p-md-5 p-4 mb-5 border">
            ...
            <div class="col-md-12 form-group">
                <h3 class="text-warning">Daftar</h3><br>
            </div>
          
            <div class="row">
                <div class="col-md-12 form-group">
                  <label for="nama">Nama</label>
                  <input type="text" id="nama" class="form-control" value="Bejo">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 form-group">
                    ...
                    <input type="text" id="email" class="form-control" value="bejo@email.com">
                </div>
            </div>
            ...
            <div class="col-md-12 form-group">
                ...
                <input type="password" id="password" class="form-control" value="bejo123">
            </div>
            </div>

              <div class="row">
                <div class="col-md-12 form-group">
                    <a href="cost_home.php" class="btn btn-warning text-white font-weight-bold"> Logout</a>
                </div>
              </div>
    ...
    <div>
        <div class="navbar-fixed">
            ...
            <li><a class="active" href="cost_akun.php">Akun</a></li>
