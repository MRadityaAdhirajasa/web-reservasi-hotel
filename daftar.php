...
<body>
    ...
    <div class="container" style="margin-top:-550px">
        <div class="row site-hero-inner justify-content-center align-items-center">
          ...
          <form style="" action="cost_masuk.php" method="post" class="bg-white p-md-5 p-4 mb-5 border">
            ...
            <div class="col-md-12 form-group">
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                    <a href="admin_masuk.php">Masuk Sebagai Admin</a><br>
                    <a href="cost_masuk.php">Masuk Sebagai Costumer</a>
                </div>
              </div>
